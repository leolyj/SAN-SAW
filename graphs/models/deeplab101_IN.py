...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, dilation=1, downsample=None, bn_momentum=0.1,IN=False):
...
class ResNetMulti(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1,IN=False):
        downsample = None
...
def DeeplabMulti101_IN(args,num_classes=21, pretrained=True):
